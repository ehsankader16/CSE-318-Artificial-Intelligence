...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        i,j = cell
        neighbors = set()
        # print the contents of the knowledge
        ...
        #         continue
        #     if neighbor not in self.moves_made and neighbor not in self.mines:
        #         undetermined_cells.add(neighbor)
        ...
        for neighbor in neighbors:
            ...
            if neighbor not in self.moves_made:
                if neighbor in self.mines:
                    ...
                    undetermined_cells.add(neighbor)
        sentence = Sentence(undetermined_cells, count)
        ...
        for sentence in self.knowledge:
            ...
            if sentence.known_safes():
                for safe in sentence.known_safes().copy():
                    self.mark_safe(safe)
        #5)
        updated_knowledge = self.knowledge.copy()
        while updated_knowledge:
            sentence1 = updated_knowledge.pop()
            set1, count1 = sentence1.cells, sentence1.count
            for sentence2 in updated_knowledge:
